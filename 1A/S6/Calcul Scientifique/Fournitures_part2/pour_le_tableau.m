...
%%
tic
[V_v1, W_v1, ~, ~] = subspace_iter_v1(M, search_space, percentage, eps, maxit);
...
plot(inter, diff_eig, 'bo', 'LineWidth', 1.5)
plot(inter, diff_v1, 'c*', 'LineWidth', 1.5)
plot(inter, diff_v2, 'ko', 'LineWidth', 1.5)
...
fprintf('\nComparaison des temps d''exécution et des erreurs:\n');
fprintf('-------------------------------------------------------\n');
fprintf('Méthode       | Temps (s) | RMSE (k=40) | RMSE (k=200)\n');
fprintf('-------------------------------------------------------\n');
fprintf('SVD standard  | %9.4f | %11.2f | %11.2f\n', toc, differenceSVD(1), differenceSVD(end));
fprintf('eig           | %9.4f | %11.2f | %11.2f\n', toc, diff_eig(1), diff_eig(end));
fprintf('subspace_v1   | %9.4f | %11.2f | %11.2f\n', toc, diff_v1(1), diff_v1(end));
fprintf('subspace_v2   | %9.4f | %11.2f | %11.2f\n', toc, diff_v2(1), diff_v2(end));
fprintf('-------------------------------------------------------\n');