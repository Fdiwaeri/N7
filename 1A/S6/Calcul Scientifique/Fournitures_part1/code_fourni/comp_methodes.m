...
title('Temps d''exécution de eig en fonction de la taille ');
...
title('Temps d''exécution de la méthode iterv2');
xlabel('Taille de la matrice n');
ylabel('Temps (secondes)');
legend show;
grid on;
hold off;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Mesure le temps d'exécution de la fonction subspace_iter_v3 pour différents types de matrices et tailles
m = 15;             % nombre de couples propres à calculer
eps = 1e-8;
maxit = 10000;
percentage = 0.5; % seuil de trace cumulée pour arrêter
...
for imat = 1:nb_types
    ...
    for i = 1:length(n_values)
        ...
        tic;
        [ V, D, n_ev, it, itv, flag ] = subspace_iter_v3( A, m, percentage, p, eps, maxit );
        exec_times(i) = toc;
    end
...
title('Temps d''exécution de la méthode iterv3');
xlabel('Taille de la matrice n');
ylabel('Temps (secondes)');
legend show;
grid on;
