...
/** Construire le schéma proposé dans le sujet de TP avec des X (points,
  * points nommés et segments), en employant l'interface List
  * et sa réalisation ArrayList.
  * Dans cette version, on utilise les méthodes add et forEach.
  *
  * @author	F.E
  */
public class ExempleSchemaListForEach {
	...
	public static void main(String[] args)
	{
		...
		ArrayList<X> schema = new ArrayList<>();	// le schéma
		...
		Ecran ecran = new Ecran("ExempleSchemaList utilisant forEach", 600, 400, 20);
		ecran.dessinerAxes();
