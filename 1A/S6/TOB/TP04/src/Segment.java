...
public class Segment {
	...
	*/
	...
	/** Dessiner le segement sur un écran.
	 * @param ecran l'écran
	 */
	public void dessiner(Ecran ecran){
		ecran.dessinerLigne(extremite1.getX(), extremite1.getY(),
				extremite2.getX(), extremite2.getY(), couleur);
	}

	/** Dessiner un segment par un afficheur SVG.
	 * @param afficheurSVG l'afficheur SVG
	 */
	public void dessinerSVG(AfficheurSVG afficheurSVG){
		afficheurSVG.dessinerLigne(extremite1.getX(), extremite1.getY(),
				extremite2.getX(), extremite2.getY(), couleur);
	}

	/** Dessiner un segment par un afficheur Texte.
	 * @param afficheurTexte l'afficheur Texte
	 */
	public void dessinerTexte(AfficheurTexte afficheurTexte){
		afficheurTexte.dessinerLigne(extremite1.getX(), extremite1.getY(),
				extremite2.getX(), extremite2.getY(), couleur);
	}
}
