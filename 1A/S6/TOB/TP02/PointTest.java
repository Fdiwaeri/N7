...
public class PointTest {
    ...
    @Test
    public void testInitialisationCouleur() {
        assertTrue(p1.getCouleur() == java.awt.Color.green);
        assertTrue(p2.getCouleur() == java.awt.Color.green);
    }

    @Test
    public void testSetCouleur() {
        p1.setCouleur(java.awt.Color.red);
        assertFalse(p1.getCouleur() == java.awt.Color.green);
