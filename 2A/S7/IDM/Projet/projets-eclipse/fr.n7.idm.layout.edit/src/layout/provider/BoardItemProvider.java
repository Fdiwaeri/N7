...
/**
 * This is the item provider adapter for a {@link layout.Board} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoardItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Board_nom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Board_nom_feature", "_UI_Board_type"),
				 LayoutPackage.Literals.BOARD__NOM,
				 true,
				 false,
				 false,
	...
	protected void addLargeurPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Board_largeur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Board_largeur_feature", "_UI_Board_type"),
				 LayoutPackage.Literals.BOARD__LARGEUR,
				 true,
				 false,
				 false,
	...
	protected void addHauteurPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Board_hauteur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Board_hauteur_feature", "_UI_Board_type"),
				 LayoutPackage.Literals.BOARD__HAUTEUR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LayoutPackage.Literals.BOARD__COUCHES);
		}
	...
	public String getText(Object object) {
		String label = ((Board)object).getNom();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LayoutPackage.Literals.BOARD__COUCHES,
				 LayoutFactory.eINSTANCE.createCoucheExterne()));

		newChildDescriptors.add
			(createChildParameter
				(LayoutPackage.Literals.BOARD__COUCHES,
				 LayoutFactory.eINSTANCE.createCoucheInterne()));
	}
