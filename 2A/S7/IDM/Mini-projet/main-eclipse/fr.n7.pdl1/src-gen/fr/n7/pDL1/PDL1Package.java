...
public interface PDL1Package extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Usageresources</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int WORK_DEFINITION__USAGERESOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 1;

  /**
   * The feature id for the '<em><b>Useages</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int WORK_DEFINITION__USEAGES = PROCESS_ELEMENT_FEATURE_COUNT + 2;
  ...
  /**
   * The meta object id for the '{@link fr.n7.pDL1.impl.UsageResourceImpl <em>Usage Resource</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL1.impl.UsageResourceImpl
   * @see fr.n7.pDL1.impl.PDL1PackageImpl#getUsageResource()
   * @generated
   */
   ...
   * @ordered
   */
  int USAGE_RESOURCE__RESOURCE = 0;
   ...
   * @ordered
   */
  int USAGE_RESOURCE__USAGE_QUANTITY = 1;
   ...
   * @ordered
   */
  int USAGE_RESOURCE__USAGE_TIME = 2;
   ...
   * @ordered
   */
  int USAGE_RESOURCE_FEATURE_COUNT = 3;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.Process#getResources <em>Resources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Resources</em>'.
   * @see fr.n7.pDL1.Process#getResources()
   * @see #getProcess()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.WorkDefinition#getUsageresources <em>Usageresources</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Usageresources</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getUsageresources()
   * @see #getWorkDefinition()
   * @generated
   */
  EReference getWorkDefinition_Usageresources();

  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL1.WorkDefinition#getUseages <em>Useages</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Useages</em>'.
   * @see fr.n7.pDL1.WorkDefinition#getUseages()
   * @see #getWorkDefinition()
   * @generated
   */
  EReference getWorkDefinition_Useages();
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.Resource#getQuantity <em>Quantity</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Quantity</em>'.
   * @see fr.n7.pDL1.Resource#getQuantity()
   * @see #getResource()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.Resource#getDescription <em>Description</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Description</em>'.
   * @see fr.n7.pDL1.Resource#getDescription()
   * @see #getResource()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link fr.n7.pDL1.UsageResource <em>Usage Resource</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Usage Resource</em>'.
   * @see fr.n7.pDL1.UsageResource
   * @generated
   */
  EClass getUsageResource();

  /**
   * Returns the meta object for the reference '{@link fr.n7.pDL1.UsageResource#getResource <em>Resource</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Resource</em>'.
   * @see fr.n7.pDL1.UsageResource#getResource()
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.UsageResource#getUsageQuantity <em>Usage Quantity</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Usage Quantity</em>'.
   * @see fr.n7.pDL1.UsageResource#getUsageQuantity()
   * @see #getUsageResource()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.n7.pDL1.UsageResource#getUsageTime <em>Usage Time</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Usage Time</em>'.
   * @see fr.n7.pDL1.UsageResource#getUsageTime()
   * @see #getUsageResource()
   * @generated
   */
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Usageresources</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference WORK_DEFINITION__USAGERESOURCES = eINSTANCE.getWorkDefinition_Usageresources();

    /**
     * The meta object literal for the '<em><b>Useages</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference WORK_DEFINITION__USEAGES = eINSTANCE.getWorkDefinition_Useages();
    ...
    /**
     * The meta object literal for the '{@link fr.n7.pDL1.impl.UsageResourceImpl <em>Usage Resource</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL1.impl.UsageResourceImpl
     * @see fr.n7.pDL1.impl.PDL1PackageImpl#getUsageResource()
