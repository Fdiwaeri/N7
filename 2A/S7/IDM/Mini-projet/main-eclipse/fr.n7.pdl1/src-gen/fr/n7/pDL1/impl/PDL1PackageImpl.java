...
public class PDL1PackageImpl extends EPackageImpl implements PDL1Package
{
   ...
   */
  @Override
  public EReference getWorkDefinition_Usageresources()
  {
   ...
   */
  @Override
  public EReference getWorkDefinition_Useages()
  {
  ...
  {
    return (EReference)usageResourceEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EAttribute)usageResourceEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(workDefinitionEClass, WORK_DEFINITION__USAGERESOURCES);
    createEReference(workDefinitionEClass, WORK_DEFINITION__USEAGES);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getProcess_Resources(), this.getResource(), null, "resources", null, 0, -1, fr.n7.pDL1.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getWorkDefinition_Usageresources(), this.getUsageResource(), null, "usageresources", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getWorkDefinition_Useages(), this.getUsageResource(), null, "useages", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getUsageResource_Resource(), this.getResource(), null, "resource", null, 0, 1, UsageResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
