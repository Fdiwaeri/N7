...
// Entry rule entryRuleUsageResource
entryRuleUsageResource returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getUsageResourceRule()); }
	iv_ruleUsageResource=ruleUsageResource
	{ $current=$iv_ruleUsageResource.current; }
	EOF;

// Rule UsageResource
ruleUsageResource returns [EObject current=null]
@init {
	enterRule();
}
@after {
