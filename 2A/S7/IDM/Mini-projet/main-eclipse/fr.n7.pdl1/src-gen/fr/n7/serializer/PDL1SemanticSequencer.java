...
public class PDL1SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == PDL1Package.eINSTANCE)
			...
			case PDL1Package.RESOURCE:
				...
				return; 
			case PDL1Package.USAGE_RESOURCE:
				sequence_UsageResource(context, (UsageResource) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (name=ID processElements+=ProcessElement* resources+=Resource*)
	 * </pre>
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID quantity=INT description=STRING?)
	 * </pre>
	 */
	 ...
	 * <pre>
	 * Contexts:
	 *     UsageResource returns UsageResource
	 *
	 * Constraint:
	 *     (resource=[Resource|ID] UsageQuantity=INT UsageTime=INT?)
	 * </pre>
	 */
	protected void sequence_UsageResource(ISerializationContext context, UsageResource semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID (usageresources+=UsageResource useages+=UsageResource*)?)
	 * </pre>
	 */
