...
public class PetriNetItemProviderAdapterFactory extends PetriNetAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link petriNet.ArcPlaceTransition} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ArcPlaceTransitionItemProvider arcPlaceTransitionItemProvider;

	/**
	 * This creates an adapter for a {@link petriNet.ArcPlaceTransition}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createArcPlaceTransitionAdapter() {
		if (arcPlaceTransitionItemProvider == null) {
			arcPlaceTransitionItemProvider = new ArcPlaceTransitionItemProvider(this);
		}

		return arcPlaceTransitionItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link petriNet.ArcTransitionPlace} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ArcTransitionPlaceItemProvider arcTransitionPlaceItemProvider;

	/**
	 * This creates an adapter for a {@link petriNet.ArcTransitionPlace}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createArcTransitionPlaceAdapter() {
		if (arcTransitionPlaceItemProvider == null) {
			arcTransitionPlaceItemProvider = new ArcTransitionPlaceItemProvider(this);
		}

		return arcTransitionPlaceItemProvider;
	}
	...
	public void dispose() {
		...
		if (arcPlaceTransitionItemProvider != null) arcPlaceTransitionItemProvider.dispose();
		if (arcTransitionPlaceItemProvider != null) arcTransitionPlaceItemProvider.dispose();
	}
