...
public class PetriNetAdapterFactory extends AdapterFactoryImpl {
	...
	protected PetriNetSwitch<Adapter> modelSwitch =
		new PetriNetSwitch<Adapter>() {
			...
			@Override
			public Adapter caseArcPlaceTransition(ArcPlaceTransition object) {
				return createArcPlaceTransitionAdapter();
			}
			@Override
			public Adapter caseArcTransitionPlace(ArcTransitionPlace object) {
				return createArcTransitionPlaceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link petriNet.ArcPlaceTransition <em>Arc Place Transition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArcPlaceTransitionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link petriNet.ArcTransitionPlace <em>Arc Transition Place</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArcTransitionPlaceAdapter() {
		return null;
	}
