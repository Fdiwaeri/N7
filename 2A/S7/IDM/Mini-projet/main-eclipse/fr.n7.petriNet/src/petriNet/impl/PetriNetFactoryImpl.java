...
public class PetriNetFactoryImpl extends EFactoryImpl implements PetriNetFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PetriNetPackage.ARC_PLACE_TRANSITION: return createArcPlaceTransition();
			case PetriNetPackage.ARC_TRANSITION_PLACE: return createArcTransitionPlace();
			default:
	 ...
	 */
	@Override
	public ArcPlaceTransition createArcPlaceTransition() {
		ArcPlaceTransitionImpl arcPlaceTransition = new ArcPlaceTransitionImpl();
		return arcPlaceTransition;
	}
	 ...
	 */
	@Override
	public ArcTransitionPlace createArcTransitionPlace() {
		ArcTransitionPlaceImpl arcTransitionPlace = new ArcTransitionPlaceImpl();
		return arcTransitionPlace;
	}
