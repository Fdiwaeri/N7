...
public interface SimplepdlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__USES = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * The feature id for the '<em><b>Usageresources</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESOURCE__USAGERESOURCES = 3;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.UsageResourceImpl <em>Usage Resource</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.UsageResourceImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getUsageResource()
	 * @generated
	 */
	int USAGE_RESOURCE = 6;

	/**
	 * The feature id for the '<em><b>Usage Quantity</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int USAGE_RESOURCE__USAGE_QUANTITY = 0;
	 ...
	 * @ordered
	 */
	int USAGE_RESOURCE__USAGE_TIME = 1;
	 ...
	 * @ordered
	 */
	int USAGE_RESOURCE__WORKDEFINITION = 2;
	 ...
	 * @ordered
	 */
	int USAGE_RESOURCE__RESOURCE = 3;

	/**
	 * The number of structural features of the '<em>Usage Resource</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int USAGE_RESOURCE_FEATURE_COUNT = 4;

	/**
	 * The number of operations of the '<em>Usage Resource</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int USAGE_RESOURCE_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.Process#getResources <em>Resources</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Resources</em>'.
	 * @see simplepdl.Process#getResources()
	 * @see #getProcess()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getUses <em>Uses</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getWorkDefinition_Uses();
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Resource#getDescription <em>Description</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Description</em>'.
	 * @see simplepdl.Resource#getDescription()
	 * @see #getResource()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Resource#getUsageresources <em>Usageresources</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Usageresources</em>'.
	 * @see simplepdl.Resource#getUsageresources()
	 * @see #getResource()
	 * @generated
	 */
	EReference getResource_Usageresources();

	/**
	 * Returns the meta object for class '{@link simplepdl.UsageResource <em>Usage Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Usage Resource</em>'.
	 * @see simplepdl.UsageResource
	 * @generated
	 */
	EClass getUsageResource();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.UsageResource#getUsageQuantity <em>Usage Quantity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Usage Quantity</em>'.
	 * @see simplepdl.UsageResource#getUsageQuantity()
	 * @see #getUsageResource()
	 * @generated
	 */
	EAttribute getUsageResource_UsageQuantity();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.UsageResource#getUsageTime <em>Usage Time</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Usage Time</em>'.
	 * @see simplepdl.UsageResource#getUsageTime()
	 * @see #getUsageResource()
	 * @generated
	 */
	EAttribute getUsageResource_UsageTime();

	/**
	 * Returns the meta object for the container reference '{@link simplepdl.UsageResource#getWorkdefinition <em>Workdefinition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Workdefinition</em>'.
	 * @see simplepdl.UsageResource#getWorkdefinition()
	 * @see #getUsageResource()
	 * @generated
	 */
	EReference getUsageResource_Workdefinition();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.UsageResource#getResource <em>Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getUsageResource_Resource();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference WORK_DEFINITION__USES = eINSTANCE.getWorkDefinition_Uses();
		...
		/**
		 * The meta object literal for the '<em><b>Usageresources</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESOURCE__USAGERESOURCES = eINSTANCE.getResource_Usageresources();

		/**
		 * The meta object literal for the '{@link simplepdl.impl.UsageResourceImpl <em>Usage Resource</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.UsageResourceImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getUsageResource()
		 * @generated
		 */
		EClass USAGE_RESOURCE = eINSTANCE.getUsageResource();

		/**
		 * The meta object literal for the '<em><b>Usage Quantity</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute USAGE_RESOURCE__USAGE_QUANTITY = eINSTANCE.getUsageResource_UsageQuantity();
		 ...
		 * @generated
		 */
		EAttribute USAGE_RESOURCE__USAGE_TIME = eINSTANCE.getUsageResource_UsageTime();
		 ...
		 * @generated
		 */
		EReference USAGE_RESOURCE__WORKDEFINITION = eINSTANCE.getUsageResource_Workdefinition();
		 ...
		 * @generated
		 */
		EReference USAGE_RESOURCE__RESOURCE = eINSTANCE.getUsageResource_Resource();
