 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getUses <em>Uses</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	 ...
	 * @ordered
	 */
	protected EList<UsageResource> uses;
	 ...
	 */
	@Override
	public EList<UsageResource> getUses() {
		if (uses == null) {
			uses = new EObjectContainmentWithInverseEList<UsageResource>(UsageResource.class, this, SimplepdlPackage.WORK_DEFINITION__USES, SimplepdlPackage.USAGE_RESOURCE__WORKDEFINITION);
		}
		return uses;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__USES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__USES:
				getUses().clear();
				getUses().addAll((Collection<? extends UsageResource>)newValue);
				return;
		}
