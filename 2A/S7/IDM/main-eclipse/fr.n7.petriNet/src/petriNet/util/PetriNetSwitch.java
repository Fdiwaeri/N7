...
public class PetriNetSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PetriNetPackage.ARC_PLACE_TRANSITION: {
				ArcPlaceTransition arcPlaceTransition = (ArcPlaceTransition)theEObject;
				T result = caseArcPlaceTransition(arcPlaceTransition);
				if (result == null) result = caseArc(arcPlaceTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetriNetPackage.ARC_TRANSITION_PLACE: {
				ArcTransitionPlace arcTransitionPlace = (ArcTransitionPlace)theEObject;
				T result = caseArcTransitionPlace(arcTransitionPlace);
				if (result == null) result = caseArc(arcTransitionPlace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Arc Place Transition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Arc Place Transition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArcPlaceTransition(ArcPlaceTransition object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Arc Transition Place</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Arc Transition Place</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArcTransitionPlace(ArcTransitionPlace object) {
		return null;
	}
