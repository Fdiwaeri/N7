...
public class PDL1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getGroup_2_2(), "rule__WorkDefinition__Group_2_2__0");
			...
			builder.put(grammarAccess.getUsageResourceAccess().getGroup(), "rule__UsageResource__Group__0");
			...
			builder.put(grammarAccess.getProcessAccess().getResourcesAssignment_4(), "rule__Process__ResourcesAssignment_4");
			builder.put(grammarAccess.getWorkDefinitionAccess().getNameAssignment_1(), "rule__WorkDefinition__NameAssignment_1");
			builder.put(grammarAccess.getWorkDefinitionAccess().getUsageresourcesAssignment_2_1(), "rule__WorkDefinition__UsageresourcesAssignment_2_1");
			builder.put(grammarAccess.getWorkDefinitionAccess().getUseagesAssignment_2_2_1(), "rule__WorkDefinition__UseagesAssignment_2_2_1");
			...
			builder.put(grammarAccess.getResourceAccess().getQuantityAssignment_2(), "rule__Resource__QuantityAssignment_2");
			builder.put(grammarAccess.getResourceAccess().getDescriptionAssignment_3(), "rule__Resource__DescriptionAssignment_3");
			builder.put(grammarAccess.getUsageResourceAccess().getResourceAssignment_1(), "rule__UsageResource__ResourceAssignment_1");
			builder.put(grammarAccess.getUsageResourceAccess().getUsageQuantityAssignment_2(), "rule__UsageResource__UsageQuantityAssignment_2");
			builder.put(grammarAccess.getUsageResourceAccess().getUsageTimeAssignment_3(), "rule__UsageResource__UsageTimeAssignment_3");
		}
	}
