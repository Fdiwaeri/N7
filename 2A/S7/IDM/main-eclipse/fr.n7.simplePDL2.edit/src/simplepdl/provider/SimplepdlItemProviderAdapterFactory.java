...
public class SimplepdlItemProviderAdapterFactory extends SimplepdlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link simplepdl.UsageResource} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected UsageResourceItemProvider usageResourceItemProvider;

	/**
	 * This creates an adapter for a {@link simplepdl.UsageResource}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createUsageResourceAdapter() {
		if (usageResourceItemProvider == null) {
			usageResourceItemProvider = new UsageResourceItemProvider(this);
		}

		return usageResourceItemProvider;
	}
	...
	public void dispose() {
		...
		if (usageResourceItemProvider != null) usageResourceItemProvider.dispose();
	}
