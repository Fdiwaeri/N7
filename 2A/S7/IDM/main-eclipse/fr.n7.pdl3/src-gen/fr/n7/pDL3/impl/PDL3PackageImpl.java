...
public class PDL3PackageImpl extends EPackageImpl implements PDL3Package
{
   ...
   */
  @Override
  public EReference getModel_WorkDefinitions()
  {
   ...
   */
  @Override
  public EReference getModel_WorkSequences()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(modelEClass, MODEL__WORK_DEFINITIONS);
    createEReference(modelEClass, MODEL__WORK_SEQUENCES);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getModel_WorkDefinitions(), this.getWorkDefinition(), null, "workDefinitions", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getModel_WorkSequences(), this.getWorkSequence(), null, "workSequences", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
