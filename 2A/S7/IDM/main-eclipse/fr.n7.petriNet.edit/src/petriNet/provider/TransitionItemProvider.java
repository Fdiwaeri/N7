	...
	protected void addArcsEntrantsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_arcsEntrants_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_arcsEntrants_feature", "_UI_Transition_type"),
				 PetriNetPackage.Literals.TRANSITION__ARCS_ENTRANTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addArcsSortantsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_arcsSortants_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_arcsSortants_feature", "_UI_Transition_type"),
				 PetriNetPackage.Literals.TRANSITION__ARCS_SORTANTS,
				 true,
				 false,
				 true,
				 null,
