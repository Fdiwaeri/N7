...
public class PlaceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInitialMarketingPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Initial Marketing feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInitialMarketingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_initialMarketing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_initialMarketing_feature", "_UI_Place_type"),
				 PetriNetPackage.Literals.PLACE__INITIAL_MARKETING,
				 true,
				 false,
				 false,
	...
	protected void addArcsSortantsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_arcsSortants_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_arcsSortants_feature", "_UI_Place_type"),
				 PetriNetPackage.Literals.PLACE__ARCS_SORTANTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addArcsEntrantsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_arcsEntrants_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_arcsEntrants_feature", "_UI_Place_type"),
				 PetriNetPackage.Literals.PLACE__ARCS_ENTRANTS,
				 true,
				 false,
				 true,
				 null,
