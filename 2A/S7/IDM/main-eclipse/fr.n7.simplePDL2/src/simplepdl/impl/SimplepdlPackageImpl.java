...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass usageResourceEClass = null;
	 ...
	 */
	@Override
	public EReference getResource_Usageresources() {
	 ...
	 */
	@Override
	public EClass getUsageResource() {
		return usageResourceEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getUsageResource_UsageQuantity() {
		return (EAttribute)usageResourceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getUsageResource_UsageTime() {
		return (EAttribute)usageResourceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getUsageResource_Workdefinition() {
		return (EReference)usageResourceEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getUsageResource_Resource() {
		return (EReference)usageResourceEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(resourceEClass, RESOURCE__USAGERESOURCES);

		usageResourceEClass = createEClass(USAGE_RESOURCE);
		createEAttribute(usageResourceEClass, USAGE_RESOURCE__USAGE_QUANTITY);
		createEAttribute(usageResourceEClass, USAGE_RESOURCE__USAGE_TIME);
		createEReference(usageResourceEClass, USAGE_RESOURCE__WORKDEFINITION);
		createEReference(usageResourceEClass, USAGE_RESOURCE__RESOURCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getProcess_Resources(), this.getResource(), null, "resources", null, 0, -1, simplepdl.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWorkDefinition_Uses(), this.getUsageResource(), this.getUsageResource_Workdefinition(), "uses", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getResource_Usageresources(), this.getUsageResource(), this.getUsageResource_Resource(), "usageresources", null, 0, -1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(usageResourceEClass, UsageResource.class, "UsageResource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUsageResource_UsageQuantity(), ecorePackage.getEInt(), "UsageQuantity", null, 0, 1, UsageResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUsageResource_UsageTime(), ecorePackage.getEInt(), "UsageTime", null, 0, 1, UsageResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUsageResource_Workdefinition(), this.getWorkDefinition(), this.getWorkDefinition_Uses(), "workdefinition", null, 1, 1, UsageResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUsageResource_Resource(), this.getResource(), this.getResource_Usageresources(), "resource", null, 1, 1, UsageResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
