...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.USAGE_RESOURCE: return createUsageResource();
			default:
	 ...
	 */
	@Override
	public UsageResource createUsageResource() {
		UsageResourceImpl usageResource = new UsageResourceImpl();
