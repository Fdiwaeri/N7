...
public class PDL1GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class WorkDefinitionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cUsageresourcesAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cUsageresourcesUsageResourceParserRuleCall_2_1_0 = (RuleCall)cUsageresourcesAssignment_2_1.eContents().get(0);
		private final Group cGroup_2_2 = (Group)cGroup_2.eContents().get(2);
		private final Keyword cCommaKeyword_2_2_0 = (Keyword)cGroup_2_2.eContents().get(0);
		private final Assignment cUseagesAssignment_2_2_1 = (Assignment)cGroup_2_2.eContents().get(1);
		private final RuleCall cUseagesUsageResourceParserRuleCall_2_2_1_0 = (RuleCall)cUseagesAssignment_2_2_1.eContents().get(0);
		
		//WorkDefinition :
		//    'wd' name=ID ('uses' usageresources+=UsageResource (',' useages+=UsageResource)*)?;
		@Override public ParserRule getRule() { return rule; }
		...
		//('uses' usageresources+=UsageResource (',' useages+=UsageResource)*)?
		...
		public Assignment getUsageresourcesAssignment_2_1() { return cUsageresourcesAssignment_2_1; }
		
		//UsageResource
		public RuleCall getUsageresourcesUsageResourceParserRuleCall_2_1_0() { return cUsageresourcesUsageResourceParserRuleCall_2_1_0; }
		
		//(',' useages+=UsageResource)*
		...
		//useages+=UsageResource
		public Assignment getUseagesAssignment_2_2_1() { return cUseagesAssignment_2_2_1; }
		
		//UsageResource
		public RuleCall getUseagesUsageResourceParserRuleCall_2_2_1_0() { return cUseagesUsageResourceParserRuleCall_2_2_1_0; }
	}
	...
	public class ResourceElements extends AbstractParserRuleElementFinder {
		...
		//Resource :
		//    'r' name=ID quantity=INT description=STRING? ;
		@Override public ParserRule getRule() { return rule; }
	...
	public class UsageResourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.n7.PDL1.UsageResource");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cUsageQuantityAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cUsageQuantityINTTerminalRuleCall_2_0 = (RuleCall)cUsageQuantityAssignment_2.eContents().get(0);
		private final Assignment cUsageTimeAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cUsageTimeINTTerminalRuleCall_3_0 = (RuleCall)cUsageTimeAssignment_3.eContents().get(0);
		
		//UsageResource : 'usage' resource=[Resource] UsageQuantity=INT UsageTime=INT? ;
		@Override public ParserRule getRule() { return rule; }
		
		//'usage' resource=[Resource] UsageQuantity=INT UsageTime=INT?
		public Group getGroup() { return cGroup; }
		...
		//UsageQuantity=INT
		public Assignment getUsageQuantityAssignment_2() { return cUsageQuantityAssignment_2; }
		
		//INT
		public RuleCall getUsageQuantityINTTerminalRuleCall_2_0() { return cUsageQuantityINTTerminalRuleCall_2_0; }
		
		//UsageTime=INT?
		public Assignment getUsageTimeAssignment_3() { return cUsageTimeAssignment_3; }
		
		//INT
		public RuleCall getUsageTimeINTTerminalRuleCall_3_0() { return cUsageTimeINTTerminalRuleCall_3_0; }
	}
	...
	private final UsageResourceElements pUsageResource;
	...
	public PDL1GrammarAccess(GrammarProvider grammarProvider,
		...
		this.pUsageResource = new UsageResourceElements();
	...
	//UsageResource : 'usage' resource=[Resource] UsageQuantity=INT UsageTime=INT? ;
	public UsageResourceElements getUsageResourceAccess() {
		return pUsageResource;
	}
	
	public ParserRule getUsageResourceRule() {
		return getUsageResourceAccess().getRule();
	}
